...
with fewer assigned rows/cells than this threshold are removed one at a
time, smallest first, and reassigned to the nearest surviving cluster, with
cluster sizes refreshed after each removal.
